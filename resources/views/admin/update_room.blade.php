          ...
          <div class="container-fluid">
            <div class="room-form-wrap">
              <div class="room-form-card">
                <h2 class="room-form-title">Update Room Data</h2>
                ...
                <form action="{{url('edit_room', $data->id)}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="room-form-grid">
                    ...
                    <div class="room-form-full">
                      ...
                      <textarea name="description" id="" value="{{$data->description}}">{{$data->description}}</textarea>
                    </div>
                    <div class="room-form-full">
                       <label for="">Current Image</label>
                       <br>
                           <img src="{{ asset('room/'.$data->image) }}" alt="" style="width: 120px; height: 90px; object-fit: cover; border-radius: 8px; margin-bottom: 12px;">
                    </div>
                    <div class="room-form-full">
